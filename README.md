...
📰 **[portada-engine](https://laportadapr.com)** | [Repo](https://github.com/plpk/portada-engine). Config-driven multi-tenant political news platform. 34 live markets across three brand families (La Portada in Spanish, The StatePage in English, The EnglandPage for the UK). One repo, one Vercel project, host-based routing. Monthly Gemini spend: ~$4.80/month at 34 markets on hourly cadence. 800+ Vitest tests. Categorization is rule-based with zero AI calls. AI governance guardrails protect all 34 markets from a single shared-engine fix.
